/*
    ...
    В этой задаче вам необходимо сделать все то же самое, что и в предыдущей, но оператор <
    должен быть таким, чтобы время сортировалось не по возрастанию, а по убыванию.
